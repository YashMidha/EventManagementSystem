...
const LoginPage = () => {
  const { loginWithGoogle, loginWithLocal, isAuthenticated } = useAppContext();
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center">
      <div className="bg-white p-10 rounded-xl shadow-lg text-center w-96">
        <h1 className="text-3xl font-bold text-gray-800 mb-6">Login to MEMS</h1>
        <p className="text-gray-600 mb-8">
          Access your personalized dashboard and stay updated with the latest events.
        </p>
